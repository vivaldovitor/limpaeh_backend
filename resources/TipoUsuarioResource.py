...
from models.TipoUsuario import TipoUsuario, tipoUsuariosFields
...
class TipoUsuariosResource(Resource):
    ...
    def get(self):
        try:
            ...
            return {'tipos_usuarios': marshal(tipos_usuarios, tipoUsuariosFields)}, 200
    ...
    def post(self):
        ...
        try:
            ...
            return marshal(tipo_usuario, tipoUsuariosFields), 201
...
class TipoUsuarioResource(Resource):
    ...
    def get(self, id):
        try:
            ...
            return {'tipo_usuario': marshal(tipo_usuario, tipoUsuariosFields)}, 200
        except Exception as e:
    ...
    def put(self, id):
        ...
        try:
            ...
            return marshal(tipo_usuario, tipoUsuariosFields), 200
        except IntegrityError as e:
            db.session.rollback()
